...
class RTL_SDR_FM(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.qtgui_sink_x_0.set_block_alias("Raw signal tune")
        ...
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_char*1, '/home/hamburger/Desktop/SDR_detector/fob_output.txt', True)
